...
class UsersAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        if ($default_target_Path = $this->getTargetPath($request->getSession(), $providerKey)) {
            return new RedirectResponse($default_target_Path);
        }
        ...
        if($session->get('url'))
        {
            return new RedirectResponse($session->get('url'));
    ...
    //    $this->urlGenerator->generate('plan_list')
    }
